...
CONFERENCE_CONFERENCE = 'pyss16'
CONFERENCE_SEND_EMAIL_TO = [ 'helpdesk@pyss.org', ]
CONFERENCE_TALK_SUBMISSION_NOTIFICATION_EMAIL = []
CONFERENCE_VOTING_DISALLOWED = 'https://pyss16.pyss.org/en/talk-voting/'
...
#
DEFAULT_URL_PREFIX = 'https://pyss16.pyss.org'

PINGBACK_TARGET_DOMAIN = 'pyss16.pyss.org'
